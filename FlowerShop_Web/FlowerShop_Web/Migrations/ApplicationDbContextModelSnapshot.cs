...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flower_Models.FavoriteProductDetails", b =>
                {
                    ...
                    b.ToTable("FavoriteProductDetails", (string)null);
                });
            ...
            modelBuilder.Entity("Flower_Models.ManagerUserProduct", b =>
                {
                    ...
                    b.ToTable("ManagerUserProducts", (string)null);
                });
            ...
            modelBuilder.Entity("Flower_Models.MaterialWarehouse", b =>
                {
                    ...
                    b.ToTable("MaterialWarehouses", (string)null);
                });

            modelBuilder.Entity("Flower_Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Flower_Models.Room", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Flower_Models.StockReceivedDocket", b =>
                {
                    ...
                    b.ToTable("StockReceivedDockets", (string)null);
                });
            ...
            modelBuilder.Entity("Flower_Models.StockReceivedDocketDetails", b =>
                {
                    ...
                    b.ToTable("StockReceivedDocketDetails", (string)null);
                });
            ...
            modelBuilder.Entity("Flower_Models.Message", b =>
                {
                    b.HasOne("Flower_Models.Room", "Room")
                        .WithMany("Messages")
